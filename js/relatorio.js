  ...
  const relatorios = async()=>{
    ...
    conteudo.entradas.reverse().forEach((entrada)=>{
      ...
      <td>
          <a href="baixar.html?id=${entrada._id}&matricula=${entrada.matricula}&observacao=${entrada.observacao}&data=${entrada.data}" class="btn btn-primary"><i class="bi bi-file-earmark-arrow-down"></i></a>
          <a href="editar.html?id=${entrada._id}&matricula=${entrada.matricula}" class="btn btn-secondary"><i class="bi bi-pencil"></i></a>
